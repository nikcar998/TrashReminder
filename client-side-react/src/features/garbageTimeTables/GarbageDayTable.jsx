        ...
        <Fragment >
            ...
            <Segment.Group>
                <Segment >
                    ...
                    {weekDays.map(day => (
                        <List.Item >
                            <Header as="h4" style={{textTransform:"capitalize"}} >{day}:</Header> 
                              {garbages.map(garbage => {
                            if (garbage.giorno == day) {
                                return (
                                    <List.List>
                                        <List.Item>{garbage.tipo}: dalle {garbage.ora_inizio} alle {garbage.ora_fine} </List.Item>
                                    </List.List>
                                )
                            }
                        })}
                    ...
                    <Button as={Link} to="/edit" color="green">Edit</Button>
                </Segment>
            </Segment.Group>
        </Fragment>
    )
